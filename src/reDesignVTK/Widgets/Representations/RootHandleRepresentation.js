 ...
 * @LastEditTime: 2024-07-03 10:59:34
 */
...
const newInstance = macro.newInstance(extend, 'vtkRootHandleRepresentation');

// ----------------------------------------------------------------------------

var vtkRootHandleRepresentation$1 = {
  newInstance,
  extend
};

export { vtkRootHandleRepresentation$1 as default, extend, newInstance };
